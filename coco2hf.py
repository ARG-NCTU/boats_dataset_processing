...
def convert_json_to_jsonl(json_data, output_jsonl_path, batch_size=10000):
...
def transform_json_to_jsonl(input_json_path, output_jsonl_path):
    ...
    convert_json_to_jsonl(json_data, output_jsonl_path)
...
def convert_all_annotations(input_dir, output_dir):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".json"):
            ...
            transform_json_to_jsonl(input_json_path, output_jsonl_path)
...
def main():
    ...
    convert_all_annotations(args.input_dir, args.output_dir)
