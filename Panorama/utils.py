...
def loadImages(path, frame_number, resize):
    ...
    image_path = [path + "extracted_camera1_images/" + frame_number, path + "extracted_camera2_images/" + frame_number, path + "extracted_camera3_images/" + frame_number]
    list_image = []
